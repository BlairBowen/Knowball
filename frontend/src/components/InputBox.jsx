    ...
    return (
        <div className="p-8 pb-0 flex justify-left relative">
            <input
                type="text"
                placeholder="ANSWER"
                className="w-full bg-gray-100 border-4 border-black rounded-lg p-2 md:p-4 text-base md:text-lg font-pixel text-black"
            />
            {/* In the future, this dropdown component will be dynamically rendered! */}
            <div className="absolute top-full mt-4 bg-gray-100 border-4 border-black rounded-lg p-2 md:p-4 text-base md:text-lg font-pixel text-black">
